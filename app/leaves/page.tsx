              ...
              <form onSubmit={handleSubmitLeave}>
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Textarea id="reason" placeholder="Provide a reason for your leave request" required />
                  </div>
                </div>
                <DialogFooter>
        ...
        <Tabs defaultValue="my-leaves">
          <TabsList>
            ...
            {(user.role === "super_admin" ||
              user.role === "admin" ||
              user.role === "manager" ||
              user.role === "finance") && <TabsTrigger value="team-leaves">Team Leaves</TabsTrigger>}
            ...
            <TabsContent value="team-leaves" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>View leave requests for your team</CardDescription>
                </CardHeader>
                <CardContent>
                  <Table>
                    <TableHeader>
              ...
              <Card>
                ...
                <CardContent>
                  <Table>
                    ...
                    <TableBody>
                      {filteredLeaves
                        .filter((leave) => leave.status === "pending" && leave.userId !== user.id)
                        .map((leave) => {
                          const employee = getUserById(leave.userId)
                          return (
                            <TableRow key={leave.id}>
