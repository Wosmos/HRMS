...
export default function ShiftsPage() {
  ...
  const userShiftAssignment = shiftAssignments.find(
    (assignment) => assignment.userId === user.id
  );

  const userShift = userShiftAssignment
    ? shifts.find((shift) => shift.id === userShiftAssignment.shiftId)
    : null;
      ...
      <Tabs defaultValue='all-shifts'>
        <TabsList>
          ...
          {(user.role === 'super_admin' ||
            user.role === 'admin' ||
            user.role === 'manager') && (
            <TabsTrigger value='shift-assignments'>
              Shift Assignments
            </TabsTrigger>
          )}
        </TabsList>
        ...
        <TabsContent value='all-shifts' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                All defined work shifts in the organization
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
